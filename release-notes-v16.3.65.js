(()=>{
  const entry={
    ...
    changes:[
      ...
      'Versioned Study Guide URLs with v16.3.65 so the new PDF bypasses an older cached Study Guide copy without changing learner progress.',
    ...
    filesAdded:['release-notes-v16.3.65.js'],
    filesModified:[
