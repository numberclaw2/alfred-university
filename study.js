...
function renderCompetencyReviews(out,eventCount){
  ...
  $$('[data-standard-rating]').forEach(b=>b.onclick=()=>{
    ...
    saveCompetencyReview(week,id,{...r,interval,lastRating:b.dataset.standardRating,due:addDays(startOfDay(now()),interval).toISOString(),updatedAt:new Date().toISOString()});renderReviews();
  });
}
