...
const CORE=[
  ...
  'styles.css','site.js','progress.js','study.js','learn.js','curriculum-data.js','teaching-media-overrides.js','course-data.js','academic-content.js','practical-completion.js','academic.js','assessment-data.js','assessment-completion.js','semantic-repair.js','assessment-policy.js','assessment-engine.js','readiness.js','assessment.js','quiz.js','standards.js','analytics.js','search.js','release-notes.js','patch-notes.js','manifest.webmanifest',
