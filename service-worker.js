const CACHE='alfred-u-v16-3-5-teaching-media-self-reliance-reference-sync-20260917';
const CORE=[
  ...
  'styles.css','site.js','progress.js','study.js','learn.js','curriculum-data.js','teaching-media-overrides.js','teaching-media-self-reliance.js','course-data.js','academic-content.js','practical-completion.js','academic.js','assessment-data.js','assessment-completion.js','semantic-repair.js','assessment-policy.js','assessment-engine.js','readiness.js','assessment.js','quiz.js','standards.js','analytics.js','search.js','release-notes.js','release-notes-current.js','patch-notes.js','manifest.webmanifest',
