(() => {
  const entries = [
    ...
    },
    {
      ...
      "title": "Teaching Media Content Completion — Final-Audit Candidate",
      ...
      "changes": [
        ...
        "This entry describes the v16.3.6 final-audit candidate. The release must not be described as 31/31 standalone PASS until the post-repair instructional acceptance audit, link/resource verification, runtime regression, and version/reference synchronization all pass."
      ]
    }
  ];
