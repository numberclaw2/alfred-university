window.ALFRED_RELEASES = [
  {version:'v15.7',date:'September 13, 2026',title:'CETa and Technician Preparation — Final Scope Audit',type:'Course Quality',request:'Make exam preparation sufficient and technician preparation demonstrable without expanding the course.',changes:['Retired the remaining 337 legacy template questions from graded use; retained historical IDs and records.','Added 147 original reviewed questions and retained 76 recalculated numerical items: 223 active supplementary questions. Editorial review is not external exam validation.','Practice selection now respects taught prerequisites. Optional checks use up to five questions; weekly reviews use up to twelve. Preparation and milestone tasks no longer add unrelated quizzes.','CETa breadth practice uses 100 questions, five per domain, with a 120-minute suggested window. This is not an official exam weighting.','Added a booklet-to-domain coverage map that explicitly identifies objectives without directly tagged web questions.','Clarified booklet-first review, errata, simulation versus physical experience, and the existing projects’ technician evidence requirements.','Added instrument traceability and nominal, boundary and failure-case checks to existing labs without adding calendar events.','Fixed answer-control handling, preserved grading records, updated offline assets and corrected malformed site origins.']},
  {version:'v15.6',date:'September 13, 2026',title:'Assessment Integrity — First Audit Pass',type:'Assessment Audit',request:'Check question provenance, answers, distractors and lesson alignment.',changes:['Retired 78 graded questions that repeated competency objectives as their answers. Historical IDs and saved records are preserved.','Recalculated 76 numerical answers; 71 have checked formula references and 5 have arithmetic-only checks. This is not full-bank validation.','Replaced 15 reactance/resonance distractors with missing-factor errors; clarified DC, zero-offset sinusoid and grounded-input assumptions.','Added per-question review status and source references after grading. Remaining items are explicitly pending review.','Career screen now honestly shows its available 78-question short practice form. No unrelated padding is added.','Prevented repeated submissions of the same displayed form from adding duplicate evidence.','Lesson alignment, remaining technical answers and expert difficulty calibration remain open audit work.']},
